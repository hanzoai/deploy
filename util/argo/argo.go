...
import (
	...
	"github.com/hanzoai/deploy/v3/pkg/client/clientset/versioned/typed/application/v1alpha1"
	applicationsv1 "github.com/hanzoai/deploy/v3/pkg/client/listers/application/v1alpha1"
