...
import (
	v1alpha1 "github.com/hanzoai/deploy/v3/pkg/apis/application/v1alpha1"
	applicationv1alpha1 "github.com/hanzoai/deploy/v3/pkg/client/clientset/versioned/typed/application/v1alpha1"
