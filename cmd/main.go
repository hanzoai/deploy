...
import (
	...
	appcontroller "github.com/hanzoai/deploy/v3/cmd/argocd-application-controller/commands"
	applicationset "github.com/hanzoai/deploy/v3/cmd/argocd-applicationset-controller/commands"
	cmpserver "github.com/hanzoai/deploy/v3/cmd/argocd-cmp-server/commands"
	commitserver "github.com/hanzoai/deploy/v3/cmd/argocd-commit-server/commands"
	dex "github.com/hanzoai/deploy/v3/cmd/argocd-dex/commands"
	gitaskpass "github.com/hanzoai/deploy/v3/cmd/argocd-git-ask-pass/commands"
	k8sauth "github.com/hanzoai/deploy/v3/cmd/argocd-k8s-auth/commands"
	notification "github.com/hanzoai/deploy/v3/cmd/argocd-notification/commands"
	reposerver "github.com/hanzoai/deploy/v3/cmd/argocd-repo-server/commands"
	apiserver "github.com/hanzoai/deploy/v3/cmd/argocd-server/commands"
	cli "github.com/hanzoai/deploy/v3/cmd/argocd/commands"
