...
import (
	...
	appsfake "github.com/hanzoai/deploy/v3/pkg/client/clientset/versioned/fake"
	appinformers "github.com/hanzoai/deploy/v3/pkg/client/informers/externalversions/application/v1alpha1"
