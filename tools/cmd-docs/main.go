...
import (
	...
	controller "github.com/hanzoai/deploy/v3/cmd/argocd-application-controller/commands"
	argocdappsetcontroller "github.com/hanzoai/deploy/v3/cmd/argocd-applicationset-controller/commands"
	argocddex "github.com/hanzoai/deploy/v3/cmd/argocd-dex/commands"
	reposerver "github.com/hanzoai/deploy/v3/cmd/argocd-repo-server/commands"
	argocdserver "github.com/hanzoai/deploy/v3/cmd/argocd-server/commands"
	argocdcli "github.com/hanzoai/deploy/v3/cmd/argocd/commands"
)
